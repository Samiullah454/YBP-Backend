...
{
    [AutoMapFrom(typeof(Technician))]
    public class TechnicianDto : EntityDto<int>
    {
        public int TechnicianTypeId { get; set; }
         public TechnicianTypeNameDto TechnicianTypes { get; set; }
        ...
        public ShiftNameDto  Shifts { get; set; }
        public int? CrewGroupId { get; set; }

        public GrewGroupNameDto CrewGroups { get; set; }
        public string DriverLicense { get; set; }
        public string SSN { get; set; }
        public DateTime DOB { get; set; }
        public int ServiceAreasId { get; set; }
        public int[]? IdsToDel { get; set; }
        public ServiceAreaNameDto ServiceAreas { get; set; }
        public ICollection<TechnicianServicesDto> TechnicianServices { get; set; }
