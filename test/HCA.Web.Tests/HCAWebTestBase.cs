...
{
    public abstract class HCAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HCAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HCAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HCADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HCADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HCADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HCADbContext, Task<T>> func)
        {
            T result;
